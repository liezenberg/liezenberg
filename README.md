...
<p align="left">I am an Android Developer with over 4 years of commercial experience.</p>
<ul>
  <li>Skilled in full development cycle, from feature planning to publishing on Google Play Store</li>
  <li>Developed and maintained apps with over 100K downloads and 10K+ daily active users</li>
  <li>Following modern trends such as Jetpack Compose, koin, Hilt etc.</li>  
  <li>Successfully collaborated in teams ranging from 2 to 31 members</li>
  <li>Conducted sprint demos on behalf of the team</li>
  <li>Additional skills in cross-platform development and designing user flows in Figma when a designer isn’t available</li>
  <li>When in Rome, do as the Romans do – easily adapt to team workflows, following all guidelines and recommendations</li>
...
<div align="left">
  ...
  <img width="11" />
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/drupal/drupal-original.svg" height="45" alt="drupal logo"  />
  <img width="11" />
